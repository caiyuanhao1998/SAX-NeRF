...
def config_parser():
    ...
    parser.add_argument("--ctName", default="carp", type=str,
                        help="Name of CT")
    parser.add_argument("--outputName", default="carp_50", type=str,
...
def main():
    ...
    configPath = f"./dataGenerator/{dataFolder}/{dataType}/config_640_dv.yml"
...
def generator(matPath, configPath, outputPath, dataFolder, dataType, show=False):
    ...
    if show or True:
        ...
        show_dir_train_proj = (show_dir_train_proj - show_dir_train_proj.min()) / (show_dir_train_proj.max() - show_dir_train_proj.min())
        show_dir_vali_proj = (show_dir_vali_proj - show_dir_vali_proj.min()) / (show_dir_vali_proj.max() - show_dir_vali_proj.min())
