...
path = f'../data/{category}_50_4dz.pickle'
...
CT_image = np.rot90(CT_image, 2, (0,2))
...
fps = 60
duration = 1000 / fps
gif_filename = os.path.join(series_save_dir, f'rotate_{category}_fps_{fps}_frame_{proj_num}.gif')
