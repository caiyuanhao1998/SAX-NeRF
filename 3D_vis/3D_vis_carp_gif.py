...
CT_image = np.rot90(CT_image, 1, (1,2))
CT_image = CT_image[::-1,:,:]
# CT_image = CT_image[...,::-1]
# CT_image = CT_image[...,::-1]
# CT_image = CT_image[::-1,...]
...
ax.set_xlim(0+dx, x+dx)
ax.set_ylim(0+dy, y+dy)
ax.set_zlim(0+dz, z+dz)
...
elevation = 20
series_save_dir = os.path.join(save_dir,f"elevation_{elevation}_sigma_{sigma}_alpha_{alpha}_frame{proj_num}_flip4_reverse_axisoff/")
print(series_save_dir)
...
# box = (350, 800, 1700, 1500)
box = (400, 800, 1800, 1500)
